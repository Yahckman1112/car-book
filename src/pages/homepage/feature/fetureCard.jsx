      ...
      >
        ...
        <CardBody>
          <p className={styles.card_para1}>
            {" "}
            <Link className={styles.carName} to="#">
              {carName}
            </Link>{" "}
          </p>
          <p>
            ...
            <span className={styles.card_para3}>
              {" "}
              {days}
              <span className={styles.card_para3_sub}>/day</span>
            </span>
          </p>
          <div className={styles.card_btn}>
            <Link to="#" className={styles.card_btn_book}>
              Book
            </Link>
            <Link to="#" className={styles.card_btn_det}>
              Details
            </Link>
          </div>
        </CardBody>
